...
export function Wcat({ mobile = false, label, insideLabel = 'wcat is inside' }: { mobile?: boolean; label: string; insideLabel?: string }) {
  ...
  const props = { mobile, label, visited, onEnter: enter, onHide: hide, onExit: exit }
  return <>
