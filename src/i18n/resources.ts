...
export const resources: Resources = {
  en: {
    'os.mobile.sections': 'Sections',
    'os.mobile.readme': 'About',
    'os.mobile.work': 'Work',
    'os.mobile.art': 'Art',
    'os.mobile.contact': 'Contact',
    'os.play.open': 'Stickers',
    'os.phone.yarn': 'Yarn',
    'os.phone.pet': 'Pet',
    'os.phone.tilt': 'Tilt',
    'os.phone.enable': 'Enable phone tilt',
    'os.phone.disable': 'Disable phone tilt',
    'os.phone.recenter': 'Recenter',
    'os.phone.asking': 'Allow motion in the browser prompt.',
    'os.phone.waiting': 'Hold comfortably. Finding your tilt…',
    'os.phone.on': 'Tilt to roll. This angle is your center.',
    'os.phone.denied': 'Motion blocked. Touch play still works.',
    'os.phone.unavailable': 'No motion data. Touch play still works.',
    'os.phone.reduced': 'Tilt is off for reduced motion.',
    'os.phone.catHelp': 'Tap to poke the cat. Hold to drag or throw; place gently on a card heading. Use Pet for affection.',
    'os.phone.yarnHelp': 'Hold to throw the yarn for the cat. Tilt to roll it; tap Yarn to put it away.',
    'os.play.close': 'Close toys',
    'os.play.help': 'Tap an emoji, then tap the page to place it. Hold to drag the cat or yarn. Tap yarn again to put it away.',
    'os.play.erase': 'Remove stickers',
    'os.play.erasing': 'Tap a sticker to remove it for everyone.',
    'os.play.placing': 'Tap the page to place your sticker.',
    'os.play.cancel': 'Cancel',
    'os.play.done': 'Done',
    ...
    'os.wcat.yarn': 'Yarn toy, only yours',
    'os.wcat.yarnHelp': 'Your yarn toy. Drag to throw; hold first on touch. The cat plays, then loses interest. Right-click to remove. Keyboard: Space to lift or drop, arrows to move, Delete to remove.',
  ...
  es: {
    'os.mobile.sections': 'Secciones',
    'os.mobile.readme': 'Sobre mí',
    'os.mobile.work': 'Trabajo',
    'os.mobile.art': 'Arte',
    'os.mobile.contact': 'Contacto',
    'os.play.open': 'Stickers',
    'os.phone.yarn': 'Ovillo',
    'os.phone.pet': 'Mimos',
    'os.phone.tilt': 'Inclinar',
    'os.phone.enable': 'Activar inclinación',
    'os.phone.disable': 'Desactivar inclinación',
    'os.phone.recenter': 'Centrar',
    'os.phone.asking': 'Permite el movimiento en el aviso del navegador.',
    'os.phone.waiting': 'Sujeta el móvil cómodamente. Calibrando…',
    'os.phone.on': 'Inclina para rodar. Este ángulo es tu centro.',
    'os.phone.denied': 'Movimiento bloqueado. Puedes jugar con el tacto.',
    'os.phone.unavailable': 'Sin datos de movimiento. Puedes jugar con el tacto.',
    'os.phone.reduced': 'Inclinación desactivada por movimiento reducido.',
    'os.phone.catHelp': 'Toca para picar al gato. Mantén pulsado para arrastrar o lanzar; déjalo suavemente en un título. Usa Mimos para acariciarlo.',
    'os.phone.yarnHelp': 'Mantén pulsado para lanzar el ovillo al gato. Inclina para rodarlo; toca Ovillo para guardarlo.',
    'os.play.close': 'Cerrar juguetes',
    'os.play.help': 'Toca un emoji y luego la página para colocarlo. Mantén pulsado el gato o el ovillo para moverlos. Toca el ovillo de nuevo para guardarlo.',
    'os.play.erase': 'Quitar stickers',
    'os.play.erasing': 'Toca un sticker para quitarlo para todos.',
    'os.play.placing': 'Toca la página para colocar el sticker.',
    'os.play.cancel': 'Cancelar',
    'os.play.done': 'Listo',
    ...
    'os.wcat.yarn': 'Ovillo de lana, solo tuyo',
    'os.wcat.yarnHelp': 'Tu ovillo de lana. Arrastra para lanzar; mantén pulsado primero en pantalla táctil. El gato juega y luego pierde el interés. Clic derecho para quitarlo. Teclado: espacio para levantar o soltar, flechas para mover, Suprimir para quitarlo.',
